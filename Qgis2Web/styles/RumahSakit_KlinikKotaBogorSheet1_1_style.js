var size = 0;
var placement = 'point';
function categories_RumahSakit_KlinikKotaBogorSheet1_1(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                switch(value.toString()) {case 'Klinik':
                    return [ new ol.style.Style({
        image: new ol.style.Circle({radius: 10.4 + size,
            stroke: new ol.style.Stroke({color: 'rgba(227,26,28,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 1}), fill: new ol.style.Fill({color: 'rgba(166,206,227,1.0)'})}),
...
var style_RumahSakit_KlinikKotaBogorSheet1_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Jenis (RS/Klinik)");
    var labelText = "";
    size = 0;
...
var style = categories_RumahSakit_KlinikKotaBogorSheet1_1(feature, value, size, resolution, labelText,
